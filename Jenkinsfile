pipeline {
    ...
    environment {
        ...
        FRONTEND_REPO = '060255765406.dkr.ecr.us-west-1.amazonaws.com/devops-challenge-frontend'
        BACKEND_REPO  = '060255765406.dkr.ecr.us-west-1.amazonaws.com/devops-challenge-backend'
    }
